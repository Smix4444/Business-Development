...
import { Briefcase, MessageSquare, Zap, ShieldCheck, UserCheck, TrendingUp, AlertCircle, Shuffle, CheckCircle2, Shield, FileSearch, Flame } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:pb-12 md:pt-24">
        ...
        >
          ...
          <Link to="/login" className="mt-8 group relative inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-white transition-all duration-300 bg-gradient-to-r from-pink-500 to-purple-600 font-pj rounded-full shadow-lg hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-purple-300 hover:scale-105 active:scale-95">
            Start Swiping
            <Flame className="ml-3 w-6 h-6 group-hover:scale-110 group-hover:animate-pulse" fill="currentColor" />
          </Link>
        </motion.div>
        ...
        { /* Pricing Section */ }
        <div id="pricing" className="py-24 max-w-5xl mx-auto">
          <motion.div
          ...
          >
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400">
              Clear plans to accelerate your career or find the best talent.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-white/40 dark:bg-black/40 backdrop-blur-xl p-8 md:p-12 rounded-[3rem] border border-white/40 shadow-xl flex flex-col items-center text-center transition-all hover:shadow-2xl hover:-translate-y-2 hover:bg-white/50 dark:hover:bg-black/50"
            >
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">School Package</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-8 w-full text-center">Empower students to match with their dream internship.</p>
              <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 mb-2">
                €2,999
              </div>
              <div className="text-slate-500 dark:text-slate-400 font-medium mb-8">per year</div>
              ...
              <ul className="space-y-4 mb-10 text-left w-full px-4">
                ...
                <li className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                  <CheckCircle2 className="text-pink-500 flex-shrink-0" size={20} />
                  <span>Partner company access</span>
                </li>
                <li className="flex items-center gap-3 text-slate-700 dark:text-slate-300">
                  <CheckCircle2 className="text-pink-500 flex-shrink-0" size={20} />
              ...
              <button className="w-full py-4 px-8 mt-auto rounded-full bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 font-bold hover:bg-slate-800 dark:hover:bg-white transition-colors shadow-lg hover:shadow-xl">
                Get Started
              </button>
            </motion.div>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-pink-500/10 to-purple-600/10 backdrop-blur-xl p-8 md:p-12 rounded-[3rem] border border-pink-500/30 shadow-2xl flex flex-col items-center text-center transition-all hover:shadow-pink-500/20 hover:-translate-y-2 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 bg-gradient-to-l from-pink-500 to-purple-600 text-white text-xs font-bold px-4 py-1.5 rounded-bl-xl shadow-sm">
                POPULAR
              </div>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Business Package</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-8 w-full text-center">Find the best match for your internship positions effortlessly.</p>
              <div className="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 mb-2">
                19,99€
              </div>
              <div className="text-slate-500 dark:text-slate-400 font-medium mb-8">per month</div>
              ...
              <button className="w-full py-4 px-8 mt-auto rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-bold hover:shadow-lg hover:scale-105 transition-all">
                Subscribe Now
              </button>
            </motion.div>
          </div>
